...
function validateEmail() {
	...
	if (!mailFormat.test(email)) {
		...
		errorMessageContainer.classList.add('login-error-message');

		const errorMessageText = document.createElement('p');
		errorMessageContainer.appendChild(errorMessageText);
		errorMessageText.innerHTML = 'Email is incorrect!';

		loginFormContainer.insertBefore(errorMessageContainer, loginFooter);
