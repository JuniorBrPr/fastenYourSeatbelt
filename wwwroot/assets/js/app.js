...
var translations = {
	...
	about: {
		...
		corenbuddy: {
			nl: "CorenBuddy is het meest geavanceerde platform om jouw Travel Buddy te vinden, gebasseerd op het meest efficiente matching systeem. Vind nu een bijpassende " +
				"reisgenoot met dezelfde interesses en dromen. Vlieg samen, geniet samen!",
			en: "CorenBuddy is the most advanced platform to find your Travel Buddy, based on the most efficient matching system. Now find a matching " +
				"travel companion with the same interests and dreams. Fly together, enjoy together!",
			es: "CorenBuddy es la plataforma más avanzada para encontrar a tu Travel Buddy, basada en el sistema de emparejamiento más eficiente. Ahora encuentra una coincidencia " +
		...
		historyDescr: {
			nl: "De onderneming Corendon is in 2000 opgericht in Haarlem, toen Atilay Uslu en zijn zakenpartner Yildiray Karaer besloten hun krachten te bundelen.  Voor die tijd had de jonge ondernemer Uslu al zijn eerste stappen in de reisbranche gezet, maar het echte succes kwam met de oprichting van Corendon." +
			...
			en: "The company Corendon was founded in 2000 in Haarlem, when Atilay Uslu and his business partner Yildiray Karaer decided to join forces. Before then, the young entrepreneur Uslu had already taken his first steps in the travel industry, but the real success came with the establishment of Corendon." +
			...
			es: "La empresa Corendon se fundó en el año 2000 en Haarlem, cuando Atilay Uslu y su socio comercial Yildiray Karaer decidieron unir fuerzas. Antes de eso, el joven emprendedor Uslu ya había dado sus primeros pasos en la industria de viajes, pero el verdadero éxito llegó con el establecimiento de Corendon." +
		...
		whoAreWeDescr: {
			nl: "Wij zijn een team van getalenteerde studenten op de Hogeschool van Amsterdam met een visie om het beste platform te ontwikkelen voor het project Fasten Your Seatbelts." +
				"tDit is het eerste project dat ons is voorgelegd in ons eerste blok van de studie.",
			en: "We are a team of talented students at the Hogeschool van Amsterdam with a vision to develop the best platform for the Fasten Your Seatbelts project." +
				"“tThis is the first project presented to us in our first block of the study.",
			es: " Somos un equipo de estudiantes talentosos en la Hogeschool van Amsterdam con la visión de desarrollar la mejor plataforma para el proyecto Fasten Your Seatbelts." +
	...
	terms: {
		...
		privacyDescr: {
			nl: "Bij Corenbuddy staat privacy op nummer één. Alle gegevens van de gebruiker" +
		...
		customerContactDescr: {
			nl: "Het is belangrijk als u contact wilt zoeken met ons dat wij een aantal" +
				...
				"telefoonnummer.",
			en: "It is important if you want to contact us that we have a number of" +
				"have data from you, this makes communication smoother and" +
				"you can be helped faster. Think of your email address and/or" +
				"phone number.",
			es: " Es importante si desea contactarnos que contamos con un número de" +
		...
		findMatchDescr: {
			nl: "Om een goede match voor u te kunnen vinden is het belangrijk dat wij" +
			...
			en: "In order to find a good match for you, it is important that we" +
			...
			es: " Para encontrar una buena pareja para ti, es importante que nosotros" +
		...
		contactMatchesDescr: {
			nl: "Nadat u een macht heeft gemaakt met een van de andere gebruikers, heeft" +
				...
				"uw contact gegevens.",
			en: "After creating a power with one of the other users, " +
			...
			es: " Después de crear un poder con uno de los otros usuarios, " +
		...
		corendonDescr: {
			nl: "Wij als corenbuddy zijn een dochtermaatschappij. Dit houdt in dat ook" +
				...
				"aan u aanbied.",
			en: "We as corenbuddy are a subsidiary. This means that also" +
				...
				"offer to you.",
			es: " Nosotros, como corenbuddy, somos una subsidiaria. Eso significa que también" +
		...
		deleteDataDescr: {
			nl: "Bij het verwijderen van uw account worden ook uw persoonsgegevens uit onze" +
			...
			en: "When you delete your account, your personal data will also be removed from our" +
				"database deleted. Would you like to use our" +
				"service, you must provide us with your details again.",
			es: " Cuando elimine su cuenta, sus datos personales también se eliminarán de nuestra" +
		...
		serviceDescr: {
			nl: "Wij bieden u een manier aan om een reispartner te kunnen vinden. Hieraan" +
				"hebben wij een aantal regels gesteld",
			en: "We offer you a way to find a travel partner. To this" +
				"We have set some rules",
			es: " Le ofrecemos una forma de encontrar un compañero de viaje. A esto" +
		...
		secondUsageDescr: {
			...
			en: "Contact between matches is made by the persons themselves. Corenbuddy" +
			...
			es: " El contacto entre partidos lo hacen las propias personas. Corenbuddy" +
		...
		determineMatchesDescr: {
			nl: "De lijst van machtes wordt bepaald op basis van uw reisbestemming, de" +
			...
			en: "The list of powers is determined based on your travel destination, the" +
			...
			es: " La lista de poderes se determina en función de su destino de viaje, el" +
		...
		firstLiability: {
			nl: "Corenbuddy is niet verantwoordelijk voor situaties die voortvloeien uit" +
				"afspraken die zijn gemaakt tijdens privè contact tussen de matches.",
			en: "Corenbuddy is not responsible for situations arising from" +
				"arrangements made during private contact between the matches.",
			es: " Corenbuddy no se hace responsable de situaciones derivadas de " +
				"arreglos hechos durante el contacto privado entre los partidos.",
		},
		secondLiability: {
			nl: "Corenbuddy is niet verantwoordelijk voor problemen die ontstaan tijdens" +
				"de reis met je match, hiervoor verwijzen wij u naar de",
			en: "Corenbuddy is not responsible for problems that arise during " +
				"the journey with your match, for this we refer you to the",
			es: " Corenbuddy no se hace responsable de los problemas que surjan durante" +
		...
		firstTermsOfUseCorendon: {
			...
			es: " El uso indebido repetido de nuestro servicio de coincidencias puede resultar" +
				"en la eliminación de su cuenta.",
		},
		secondTermsOfUseCorendon: {
			nl: "Corenbuddy probeert in al zijn capaciteiten misbruikers op te sporen en" +
				"aan te pakken. Wij raden onze gebruikers aan om nooit zomaar betalingen" +
				"te maken zonder de juiste kennis over uw match.",
			en: "Corenbuddy tries in all his capacities to track down abusers and" +
				" We advise our users never to make payments without" +
				"without proper knowledge about your match.",
			es: " Corenbuddy intenta en todas sus capacidades rastrear a los abusadores y" +
		...
		thirdTermsOfUseCorendon: {
			nl: "Na wederzijdse acceptatie van een match is corenbuddy niet meer" +
				"verantwoordelijk voor het bekent worden van uw contactgegevens aan uw" +
				"match.",
			en: "After mutual acceptance of a match, corenbuddy is no longer" +
				"responsible for making your contact details known to your" +
				"match.",
			es: " Después de la aceptación mutua de un partido, corenbuddy ya no está" +
